...
- Projects, repositories, plans, goals, achievements, problems, decisions, meeting notes, and history
...
7. Add your first real entries under `Projects/`, `Plans/`, `Goals/`, `Achievements/`, `Problems/`, `Decisions/`, `Meetings/`, and `History/`.
...
- Separate enduring responsibilities from time-bound projects, plans, achievements, and problems.
